...
export class AgregaregresoComponent {
  ...
  constructor(private datePipe: DatePipe,private router: Router, private fb: FormBuilder, private egresoS: AdminService) { 
  ...
  obtenerUsuarios(): void {
    this.usuarios=[]
    this.egresoS.getVerUsuarios().subscribe((data: any) => { // Aquí deberías cambiar `any` por el tipo adecuado si es diferente
      console.log(data);
